  ...
  return (
    <div className="container-fluid py-2">
      <div className="d-flex justify-content-between align-items-sm-center flex-column flex-sm-row mb-4 gap-3">
        <h2 className="fw-bold m-0">All Expenses</h2>
        
        <div className="d-flex align-items-center gap-2">
          <label className="fw-semibold text-muted mb-0">Filter by category:</label>
          <select 
      ...
      <div className="table-container">
        {filteredExpenses.length === 0 ? (
          <div className="text-center py-5">
            ...
            <Link to="/add-expense" className="btn btn-primary mt-3">Add New Expense</Link>
          </div>
        ) : (
