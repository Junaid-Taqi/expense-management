...
const AddIncome = () => {
  ...
  const predefinedSources = ['Salary', 'Business', 'Investments', 'Freelance', 'Gifts', 'Refunds', 'Other'];
  ...
  return (
    <div className="container-fluid py-2">
      <div className="d-flex align-items-center mb-4">
        ...
        <h2 className="fw-bold m-0 text-success">{isEditMode ? 'Edit Income' : 'Add New Income'}</h2>
      </div>
          ...
          <div className="table-container border-top border-success border-4">
            <form onSubmit={handleSubmit}>
              ...
              <div className="d-grid mt-4">
                <button type="submit" className="btn btn-success btn-lg d-flex align-items-center justify-content-center">
