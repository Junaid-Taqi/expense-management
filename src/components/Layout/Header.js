...
import { setCurrency, selectCurrencyCode } from '../../store/slices/currencySlice';
import { setMonthFilter, setYearFilter, selectMonthFilter, selectYearFilter } from '../../store/slices/filterSlice';
...
const Header = ({ setIsMobileOpen }) => {
  ...
  return (
    <header className="d-flex align-items-center justify-content-between p-3 mb-4 bg-card border-bottom sticky-top" style={{ backgroundColor: 'var(--bg-card)', borderColor: 'var(--border-color)', zIndex: 50 }}>
      ...
      <div className="d-flex align-items-center">
        ...
        <h4 className="m-0 fw-bold text-gradient d-md-none">Expensify</h4>
      </div>
      ...
      <div className="d-flex align-items-center gap-2 gap-sm-3 ms-auto flex-wrap justify-content-end">
        ...
        <div className="d-flex align-items-center gap-2">
          <select 
             ...
             style={{ width: 'auto', backgroundColor: 'var(--bg-color)', color: 'var(--text-main)', border: '1px solid var(--border-color)' }}
             value={monthFilter}
        ...
        {/* Currency Selector */}
        <div className="d-flex align-items-center">
           <span className="me-2 text-muted fw-semibold d-none d-sm-inline">Currency:</span>
           <select 
             className="form-select form-select-sm"
             style={{ width: 'auto', backgroundColor: 'var(--bg-color)', color: 'var(--text-main)', border: '1px solid var(--border-color)' }}
             value={currencyCode}
        ...
        <button 
          ...
          title="Export CSV"
        >
          <MdDownload className="me-1" /> <span className="d-none d-sm-inline">Export</span>
        </button>
